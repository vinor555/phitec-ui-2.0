        ...
        >
          ...
          <v-list-item-content class="ms-1 ps-1 py-0" v-if="child.items">
            ...
            >
              ...
              >
                <span class="v-list-item-mini">{{ child2.prefix }}</span>
                <v-list-item-content>
    ...
    <v-list nav dense>
      ...
      >
        <template v-slot:activator>
          ...
          <v-list-item-content>
            <v-list-item-title class="ms-1">{{ item.title }}</v-list-item-title>
          </v-list-item-content>
        </template>
        ...
        >
          <v-list-item-content class="ps-4" v-if="!child.items">
            <div class="d-flex align-items-center pa-2">
              <span class="v-list-item-mini ms-0">{{ child.prefix }}</span>
              <v-list-item-title
                class="ms-6" @click="listClose($event)">{{ child.title }}</v-list-item-title>
            </div>
          </v-list-item-content>
            ...
            >
                  ...
                  >
                    <template v-slot:activator>
                      <div class="w-100 d-flex align-center">
                        <span
                          class="v-list-item-mini ms-1">{{ child.prefix }}</span>

                        <v-list-item-content class="py-0 ms-4">
                          <v-list-item-title class="ms-2">{{ child.title }}</v-list-item-title>
                        </v-list-item-content>
                      </div>
                    </template>
                  </v-list-group>
              ...
              >
                <v-list-item-content>
                  <div class="d-flex align-items-center pa-2">
                    <span
                      class="v-list-item-mini">{{ child2.prefix }}</span>
                    <v-list-item-title class="ms-6" >{{ child2.title }}</v-list-item-title>
                  </div>
                </v-list-item-content>
              </v-list-item>
            </v-list-group>
