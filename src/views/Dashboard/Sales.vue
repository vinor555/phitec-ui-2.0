              ...
              <v-list class="py-0">
                ...
                >
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-title  class="text-typo text-sm mb-0">{{ chat.country }}</v-list-item-title>
                  </v-list-item-content>
                  ...
                  <v-list-item-content class="text-center">
                    ...
                    <v-list-item-title class="text-typo text-sm mb-0">{{ chat.sales }}</v-list-item-title>
                  </v-list-item-content>
                  ...
                  <v-list-item-content class="text-center">
                    ...
                    <v-list-item-title class="text-typo text-sm mb-0">{{ chat.bounce }}</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </v-list>
            </v-card-text>
