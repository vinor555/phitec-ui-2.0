...
export default {
  ...
  mounted () {
    const chart1 = document.getElementById(this.chartLine1).getContext('2d')
    const chart2 = document.getElementById(this.chartLine2).getContext('2d')

    const gradientStroke1 = chart1.createLinearGradient(0, 230, 0, 50)
