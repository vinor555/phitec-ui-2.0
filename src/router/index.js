...
// Dashboard pages
const UserTasks = () => import('../views/UserTask/UserTask.vue')

// Pages
const Pricing = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Pricing.vue')
const Rtl = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Rtl.vue')
const ProfileOverview = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Profile/ProfileOverview.vue')
const Messages = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Profile/Messages.vue')
const Projects = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Profile/Projects.vue')
const Reports = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Users/Reports.vue')
const NewUser = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Users/NewUser.vue')
const Settings = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Account/Settings.vue')
const Billing = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Account/Billing.vue')
const Invoice = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Account/Invoice.vue')
const Timeline = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Projects/Timeline.vue')
const Charts = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Charts.vue')
const Alerts = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Alerts.vue')
const Notifications = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Notifications.vue')
const SignUpBasic = () => import(/* webpackChunkName: "pages" */ '@/views/Pages/Authentication/SignUp/Basic.vue')
const SignUpCover = () =>
  import(
...
const OrderList = () => import(/* webpackChunkName: "pages" */ '@/views/Ecommerce/Orders/OrderList.vue')
const OrderDetails = () =>
  import(
